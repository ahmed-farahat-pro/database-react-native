...
{  const [name , setName] = useState("");
    ...
    fetch('http://localhost:3000/handle-std-mang', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
      body: JSON.stringify({ name, username , password , stdName}),
    })
      ...
      .then((data) => {
        ...
        if (data["message"] == 'already in')
        {
            ...
            navigation.navigate("MANGSIGNED",{ username:username,   });
        }
      })
      .catch((error) => {
    ...
    return( 
      ...
      <TextInput
       ...
       <View style={{marginTop: 20, flexDirection: 'row', alignItems: 'center', alignSelf: 'center'}}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("LOGIN" , {name:"stadium"})}>
